...
public class Ball {
    ...
    public Ball(Dimension screenSize) {
        ...
        radius = ((int)(Math.random()*15))+10;
        diameter = radius * 2;
        //location = new Point( (int)(Math.random()*(screenSize.width-diameter-radius)+radius),
        //                      (int)(Math.random()*(screenSize.height-diameter-radius)+radius));
